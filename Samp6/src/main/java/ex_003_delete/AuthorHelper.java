...
public class AuthorHelper {
    ...
    public int deleteCriteria(String column)  {
        Session session = sessionFactory.openSession();
        ...
        cd.where( cb.isNull( root.get(column) ));
    ...
    public int deleteCriteriaLogic(String column1, String val1, String column2, String val2)  {
        Session session = sessionFactory.openSession();
        ...
        cd.where(cb.or(
                cb.equal(root.get(column1), val1),
                cb.like(root.<String>get(column2), val2)
                )
        );
