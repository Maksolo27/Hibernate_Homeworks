...
public class CarJDBCDao extends AbstractDao implements CarDAO {
    ...
    @Override
    public void updatePrice(int price, Car current) {
        Connection connection = null;
        PreparedStatement preparedStatement = null;
        ...
        try {
            ...
            preparedStatement.setLong(2, current.getId());
